...
Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let u=ot(),d;if(t){let e=typeof t==`string`?ie(t):t;w(c===`/`||e.pathname?.startsWith(c),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${c}" but pathname "${e.pathname}" was given in the \`location\` prop.`),d=e}else d=u;let f=d.pathname||`/`,p=f;if(c!==`/`){let e=c.replace(/^\//,``).split(`/`);p=`/`+f.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let m=se(e,{pathname:p});T(l||m!=null,`No routes matched location "${d.pathname}${d.search}${d.hash}" `),T(m==null||m[m.length-1].route.element!==void 0||m[m.length-1].route.Component!==void 0||m[m.length-1].route.lazy!==void 0,`Matched leaf route at location "${d.pathname}${d.search}${d.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let h=bt(m&&m.map(e=>Object.assign({},e,{params:Object.assign({},o,e.params),pathname:je([c,r.encodeLocation?r.encodeLocation(e.pathname.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?c:je([c,r.encodeLocation?r.encodeLocation(e.pathnameBase.replace(/%/g,`%25`).replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),i,n);return t&&h?x.createElement(Xe.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,unstable_mask:void 0,...d},navigationType:`POP`}},h):h}function mt(){let e=kt(),t=Ie(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=x.createElement(x.Fragment,null,x.createElement(`p`,null,`💿 Hey developer 👋`),x.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,x.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,x.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),x.createElement(x.Fragment,null,x.createElement(`h2`,null,`Unexpected Application Error!`),x.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?x.createElement(`pre`,{style:i},n):null,o)}var ht=x.createElement(mt,null),gt=class extends x.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){let e=this.state.error;if(this.context&&typeof e==`object`&&e&&`digest`in e&&typeof e.digest==`string`){let t=rt(e.digest);t&&(e=t)}let t=e===void 0?this.props.children:x.createElement(Ze.Provider,{value:this.props.routeContext},x.createElement(Qe.Provider,{value:e,children:this.props.component}));return this.context?x.createElement(vt,{error:e},t):t}};gt.contextType=We;var _t=new WeakMap;function vt({children:e,error:t}){let{basename:n}=x.useContext(Ye);if(typeof t==`object`&&t&&`digest`in t&&typeof t.digest==`string`){let e=nt(t.digest);if(e){let r=_t.get(t);if(r)throw r;let i=ze(e.location,n);if(Re&&!_t.get(t))if(i.isExternal||e.reloadDocument)window.location.href=i.absoluteURL||i.to;else{let n=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(i.to,{replace:e.replace}));throw _t.set(t,n),n}return x.createElement(`meta`,{httpEquiv:`refresh`,content:`0;url=${i.absoluteURL||i.to}`})}}return e}function yt({routeContext:e,match:t,children:n}){let r=x.useContext(He);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(Ze.Provider,{value:e},n)}function bt(e,t=[],n){let r=n?.state;if(e==null){if(!r)return null;if(r.errors)e=r.matches;else if(t.length===0&&!r.initialized&&r.matches.length>0)e=r.matches;else return null}let i=e,a=r?.errors;if(a!=null){let e=i.findIndex(e=>e.route.id&&a?.[e.route.id]!==void 0);w(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(a).join(`,`)}`),i=i.slice(0,Math.min(i.length,e+1))}let o=!1,s=-1;if(n&&r){o=r.renderFallback;for(let e=0;e<i.length;e++){let t=i[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(s=e),t.route.id){let{loaderData:e,errors:a}=r,c=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!a||a[t.route.id]===void 0);if(t.route.lazy||c){n.isStatic&&(o=!0),i=s>=0?i.slice(0,s+1):[i[0]];break}}}}let c=n?.onError,l=r&&c?(e,t)=>{c(e,{location:r.location,params:r.matches?.[0]?.params??{},unstable_pattern:Le(r.matches),errorInfo:t})}:void 0;return i.reduceRight((e,n,c)=>{let u,d=!1,f=null,p=null;r&&(u=a&&n.route.id?a[n.route.id]:void 0,f=n.route.errorElement||ht,o&&(s<0&&c===0?(Mt(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),d=!0,p=null):s===c&&(d=!0,p=n.route.hydrateFallbackElement||null)));let m=t.concat(i.slice(0,c+1)),h=()=>{let t;return t=u?f:d?p:n.route.Component?x.createElement(n.route.Component,null):n.route.element?n.route.element:e,x.createElement(yt,{match:n,routeContext:{outlet:e,matches:m,isDataRoute:r!=null},children:t})};return r&&(n.route.ErrorBoundary||n.route.errorElement||c===0)?x.createElement(gt,{location:r.location,revalidation:r.revalidation,component:f,error:u,children:h(),routeContext:{outlet:null,matches:m,isDataRoute:!0},onError:l}):h()},null)}function xt(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function St(e){let t=x.useContext(He);return w(t,xt(e)),t}function Ct(e){let t=x.useContext(Ue);return w(t,xt(e)),t}function wt(e){let t=x.useContext(Ze);return w(t,xt(e)),t}function Tt(e){let t=wt(e),n=t.matches[t.matches.length-1];return w(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function Et(){return Tt(`useRouteId`)}function Dt(){return Ct(`useNavigation`).navigation}function Ot(){let{matches:e,loaderData:t}=Ct(`useMatches`);return x.useMemo(()=>e.map(e=>D(e,t)),[e,t])}function kt(){let e=x.useContext(Qe),t=Ct(`useRouteError`),n=Tt(`useRouteError`);return e===void 0?t.errors?.[n]:e}function At(){let{router:e}=St(`useNavigate`),t=Tt(`useNavigate`),n=x.useRef(!1);return ct(()=>{n.current=!0}),x.useCallback(async(r,i={})=>{T(n.current,st),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var jt={};function Mt(e,t,n){!t&&!jt[e]&&(jt[e]=!0,T(!1,n))}x.useOptimistic,x.memo(Nt);function Nt({routes:e,future:t,state:n,isStatic:r,onError:i}){return pt(e,void 0,{state:n,isStatic:r,onError:i,future:t})}function Pt(e){w(!1,`A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.`)}function Ft({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,unstable_useTransitions:o}){w(!at(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=x.useMemo(()=>({basename:s,navigator:i,static:a,unstable_useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=ie(n));let{pathname:l=`/`,search:u=``,hash:d=``,state:f=null,key:p=`default`,unstable_mask:m}=n,h=x.useMemo(()=>{let e=Ce(l,s);return e==null?null:{location:{pathname:e,search:u,hash:d,state:f,key:p,unstable_mask:m},navigationType:r}},[s,l,u,d,f,p,r,m]);return T(h!=null,`<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:x.createElement(Ye.Provider,{value:c},x.createElement(Xe.Provider,{children:t,value:h}))}function It({children:e,location:t}){return ft(Lt(e),t)}x.Component;function Lt(e,t=[]){let n=[];return x.Children.forEach(e,(e,r)=>{if(!x.isValidElement(e))return;let i=[...t,r];if(e.type===x.Fragment){n.push.apply(n,Lt(e.props.children,i));return}w(e.type===Pt,`[${typeof e.type==`string`?e.type:e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),w(!e.props.index||!e.props.children,`An index route cannot have child routes.`);let a={id:e.props.id||i.join(`-`),caseSensitive:e.props.caseSensitive,element:e.props.element,Component:e.props.Component,index:e.props.index,path:e.props.path,middleware:e.props.middleware,loader:e.props.loader,action:e.props.action,hydrateFallbackElement:e.props.hydrateFallbackElement,HydrateFallback:e.props.HydrateFallback,errorElement:e.props.errorElement,ErrorBoundary:e.props.ErrorBoundary,hasErrorBoundary:e.props.hasErrorBoundary===!0||e.props.ErrorBoundary!=null||e.props.errorElement!=null,shouldRevalidate:e.props.shouldRevalidate,handle:e.props.handle,lazy:e.props.lazy};e.props.children&&(a.children=Lt(e.props.children,i)),n.push(a)}),n}var Rt=`get`,zt=`application/x-www-form-urlencoded`;function Bt(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function Vt(e){return Bt(e)&&e.tagName.toLowerCase()===`button`}function Ht(e){return Bt(e)&&e.tagName.toLowerCase()===`form`}function Ut(e){return Bt(e)&&e.tagName.toLowerCase()===`input`}function Wt(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Gt(e,t){return e.button===0&&(!t||t===`_self`)&&!Wt(e)}var Kt=null;function qt(){if(Kt===null)try{new FormData(document.createElement(`form`),0),Kt=!1}catch{Kt=!0}return Kt}var Jt=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function Yt(e){return e!=null&&!Jt.has(e)?(T(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${zt}"`),null):e}function Xt(e,t){let n,r,i,a,o;if(Ht(e)){let o=e.getAttribute(`action`);r=o?Ce(o,t):null,n=e.getAttribute(`method`)||Rt,i=Yt(e.getAttribute(`enctype`))||zt,a=new FormData(e)}else if(Vt(e)||Ut(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?Ce(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||Rt,i=Yt(e.getAttribute(`formenctype`))||Yt(o.getAttribute(`enctype`))||zt,a=new FormData(o,e),!qt()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(Bt(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=Rt,r=null,i=zt,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);var Zt={"&":`\\u0026`,">":`\\u003e`,"<":`\\u003c`,"\u2028":`\\u2028`,"\u2029":`\\u2029`},Qt=/[&><\u2028\u2029]/g;function $t(e){return e.replace(Qt,e=>Zt[e])}function en(e,t){if(e===!1||e==null)throw Error(t)}function tn(e,t,n,r){let i=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return n?i.pathname.endsWith(`/`)?i.pathname=`${i.pathname}_.${r}`:i.pathname=`${i.pathname}.${r}`:i.pathname===`/`?i.pathname=`_root.${r}`:t&&Ce(i.pathname,t)===`/`?i.pathname=`${t.replace(/\/$/,``)}/_root.${r}`:i.pathname=`${i.pathname.replace(/\/$/,``)}.${r}`,i}async function nn(e,t){if(e.id in t)return t[e.id];try{let n=await b(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function rn(e){return e!=null&&typeof e.page==`string`}function an(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function on(e,t,n){return dn((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await nn(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(an).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function sn(e,t,n,r,i,a){let o=(e,t)=>n[t]?e.route.id!==n[t].route.id:!0,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function cn(e,t,{includeHydrateFallback:n}={}){return ln(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function ln(e){return[...new Set(e)]}function un(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function dn(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!rn(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(un(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function fn(){let e=x.useContext(He);return en(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function pn(){let e=x.useContext(Ue);return en(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var mn=x.createContext(void 0);mn.displayName=`FrameworkContext`;function hn(){let e=x.useContext(mn);return en(e,`You must render this element inside a <HydratedRouter> element`),e}function gn(e,t){let n=x.useContext(mn),[r,i]=x.useState(!1),[a,o]=x.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:l,onMouseLeave:u,onTouchStart:d}=t,f=x.useRef(null);x.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return f.current&&e.observe(f.current),()=>{e.disconnect()}}},[e]),x.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let p=()=>{i(!0)},m=()=>{i(!1),o(!1)};return n?e===`intent`?[a,f,{onFocus:_n(s,p),onBlur:_n(c,m),onMouseEnter:_n(l,p),onMouseLeave:_n(u,m),onTouchStart:_n(d,p)}]:[a,f,{}]:[!1,f,{}]}function _n(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function vn({page:e,...t}){let n=Ge(),{router:r}=fn(),i=x.useMemo(()=>se(r.routes,e,r.basename),[r.routes,e,r.basename]);return i?n?x.createElement(bn,{page:e,matches:i,...t}):x.createElement(xn,{page:e,matches:i,...t}):null}function yn(e){let{manifest:t,routeModules:n}=hn(),[r,i]=x.useState([]);return x.useEffect(()=>{let r=!1;return on(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function bn({page:e,matches:t,...n}){let r=ot(),{future:i}=hn(),{basename:a}=fn(),o=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=tn(e,a,i.unstable_trailingSlashAwareDataRequests,`rsc`),o=!1,s=[];for(let e of t)typeof e.route.shouldRevalidate==`function`?o=!0:s.push(e.route.id);return o&&s.length>0&&n.searchParams.set(`_routes`,s.join(`,`)),[n.pathname+n.search]},[a,i.unstable_trailingSlashAwareDataRequests,e,r,t]);return x.createElement(x.Fragment,null,o.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})))}function xn({page:e,matches:t,...n}){let r=ot(),{future:i,manifest:a,routeModules:o}=hn(),{basename:s}=fn(),{loaderData:c,matches:l}=pn(),u=x.useMemo(()=>sn(e,t,l,a,r,`data`),[e,t,l,a,r]),d=x.useMemo(()=>sn(e,t,l,a,r,`assets`),[e,t,l,a,r]),f=x.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,l=!1;if(t.forEach(e=>{let t=a.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in c&&o[e.route.id]?.shouldRevalidate||t.hasClientLoader?l=!0:n.add(e.route.id))}),n.size===0)return[];let d=tn(e,s,i.unstable_trailingSlashAwareDataRequests,`data`);return l&&n.size>0&&d.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[d.pathname+d.search]},[s,i.unstable_trailingSlashAwareDataRequests,c,r,a,u,t,e,o]),p=x.useMemo(()=>cn(d,a),[d,a]),m=yn(d);return x.createElement(x.Fragment,null,f.map(e=>x.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>x.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>x.createElement(`link`,{key:e,nonce:n.nonce,...t,crossOrigin:t.crossOrigin??n.crossOrigin})))}function Sn(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}x.Component;var Cn=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{Cn&&(window.__reactRouterVersion=`7.14.0`)}catch{}function wn({basename:e,children:t,unstable_useTransitions:n,window:r}){let i=x.useRef();i.current??=C({window:r,v5Compat:!0});let a=i.current,[o,s]=x.useState({action:a.action,location:a.location}),c=x.useCallback(e=>{n===!1?s(e):x.startTransition(()=>s(e))},[n]);return x.useLayoutEffect(()=>a.listen(c),[a,c]),x.createElement(Ft,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,unstable_useTransitions:n})}function Tn({basename:e,children:t,history:n,unstable_useTransitions:r}){let[i,a]=x.useState({action:n.action,location:n.location}),o=x.useCallback(e=>{r===!1?a(e):x.startTransition(()=>a(e))},[r]);return x.useLayoutEffect(()=>n.listen(o),[n,o]),x.createElement(Ft,{basename:e,children:t,location:i.location,navigationType:i.action,navigator:n,unstable_useTransitions:r})}Tn.displayName=`unstable_HistoryRouter`;var En=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Dn=x.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,unstable_mask:o,state:s,target:c,to:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f,...p},m){let{basename:h,navigator:g,unstable_useTransitions:_}=x.useContext(Ye),v=typeof l==`string`&&En.test(l),y=ze(l,h);l=y.to;let b=it(l,{relative:r}),ee=ot(),S=null;if(o){let e=Ae(o,[],ee.unstable_mask?ee.unstable_mask.pathname:`/`,!0);h!==`/`&&(e.pathname=e.pathname===`/`?h:je([h,e.pathname])),S=g.createHref(e)}let[C,w,T]=gn(n,p),te=Pn(l,{replace:a,unstable_mask:o,state:s,target:c,preventScrollReset:u,relative:r,viewTransition:d,unstable_defaultShouldRevalidate:f,unstable_useTransitions:_});function E(t){e&&e(t),t.defaultPrevented||te(t)}let ne=!(y.isExternal||i),re=x.createElement(`a`,{...p,...T,href:(ne?S:void 0)||y.absoluteURL||b,onClick:ne?E:e,ref:Sn(m,w),target:c,"data-discover":!v&&t===`render`?`true`:void 0});return C&&!v?x.createElement(x.Fragment,null,re,x.createElement(vn,{page:b})):re});Dn.displayName=`Link`;var On=x.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},l){let u=dt(a,{relative:c.relative}),d=ot(),f=x.useContext(Ue),{navigator:p,basename:m}=x.useContext(Ye),h=f!=null&&Wn(u)&&o===!0,g=p.encodeLocation?p.encodeLocation(u).pathname:u.pathname,_=d.pathname,v=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;t||(_=_.toLowerCase(),v=v?v.toLowerCase():null,g=g.toLowerCase()),v&&m&&(v=Ce(v,m)||v);let y=g!==`/`&&g.endsWith(`/`)?g.length-1:g.length,b=_===g||!r&&_.startsWith(g)&&_.charAt(y)===`/`,ee=v!=null&&(v===g||!r&&v.startsWith(g)&&v.charAt(g.length)===`/`),S={isActive:b,isPending:ee,isTransitioning:h},C=b?e:void 0,w;w=typeof n==`function`?n(S):[n,b?`active`:null,ee?`pending`:null,h?`transitioning`:null].filter(Boolean).join(` `);let T=typeof i==`function`?i(S):i;return x.createElement(Dn,{...c,"aria-current":C,className:w,ref:l,style:T,to:a,viewTransition:o},typeof s==`function`?s(S):s)});On.displayName=`NavLink`;var kn=x.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=Rt,action:s,onSubmit:c,relative:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f,...p},m)=>{let{unstable_useTransitions:h}=x.useContext(Ye),g=Ln(),_=Rn(s,{relative:l}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&En.test(s);return x.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:l,preventScrollReset:u,viewTransition:d,unstable_defaultShouldRevalidate:f});h&&n!==!1?x.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});kn.displayName=`Form`;function An({getKey:e,storageKey:t,...n}){let r=x.useContext(mn),{basename:i}=x.useContext(Ye),a=ot(),o=Ot();Hn({getKey:e,storageKey:t});let s=x.useMemo(()=>{if(!r||!e)return null;let t=Vn(a,o,i,e);return t===a.key?null:t},[]);if(!r||r.isSpaMode)return null;let c=((e,t)=>{if(!window.history.state||!window.history.state.key){let e=Math.random().toString(32).slice(2);window.history.replaceState({key:e},``)}try{let n=JSON.parse(sessionStorage.getItem(e)||`{}`)[t||window.history.state.key];typeof n==`number`&&window.scrollTo(0,n)}catch(t){console.error(t),sessionStorage.removeItem(e)}}).toString();return x.createElement(`script`,{...n,suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${c})(${$t(JSON.stringify(t||zn))}, ${$t(JSON.stringify(s))})`}})}An.displayName=`ScrollRestoration`;function jn(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Mn(e){let t=x.useContext(He);return w(t,jn(e)),t}function Nn(e){let t=x.useContext(Ue);return w(t,jn(e)),t}function Pn(e,{target:t,replace:n,unstable_mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,unstable_defaultShouldRevalidate:c,unstable_useTransitions:l}={}){let u=lt(),d=ot(),f=dt(e,{relative:o});return x.useCallback(p=>{if(Gt(p,t)){p.preventDefault();let t=n===void 0?re(d)===re(f):n,m=()=>u(e,{replace:t,unstable_mask:r,state:i,preventScrollReset:a,relative:o,viewTransition:s,unstable_defaultShouldRevalidate:c});l?x.startTransition(()=>m()):m()}},[d,u,f,n,r,i,t,e,a,o,s,c,l])}var Fn=0,In=()=>`__${String(++Fn)}__`;function Ln(){let{router:e}=Mn(`useSubmit`),{basename:t}=x.useContext(Ye),n=Et(),r=e.fetch,i=e.navigate;return x.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=Xt(e,t);a.navigate===!1?await r(a.fetcherKey||In(),n,a.action||o,{unstable_defaultShouldRevalidate:a.unstable_defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync}):await i(a.action||o,{unstable_defaultShouldRevalidate:a.unstable_defaultShouldRevalidate,preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Rn(e,{relative:t}={}){let{basename:n}=x.useContext(Ye),r=x.useContext(Ze);w(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...dt(e||`.`,{relative:t})},o=ot();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:je([n,a.pathname])),re(a)}var zn=`react-router-scroll-positions`,Bn={};function Vn(e,t,n,r){let i=null;return r&&(i=r(n===`/`?e:{...e,pathname:Ce(e.pathname,n)||e.pathname},t)),i??=e.key,i}function Hn({getKey:e,storageKey:t}={}){let{router:n}=Mn(`useScrollRestoration`),{restoreScrollPosition:r,preventScrollReset:i}=Nn(`useScrollRestoration`),{basename:a}=x.useContext(Ye),o=ot(),s=Ot(),c=Dt();x.useEffect(()=>(window.history.scrollRestoration=`manual`,()=>{window.history.scrollRestoration=`auto`}),[]),Un(x.useCallback(()=>{if(c.state===`idle`){let t=Vn(o,s,a,e);Bn[t]=window.scrollY}try{sessionStorage.setItem(t||zn,JSON.stringify(Bn))}catch(e){T(!1,`Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${e}).`)}window.history.scrollRestoration=`auto`},[c.state,e,a,o,s,t])),typeof document<`u`&&(x.useLayoutEffect(()=>{try{let e=sessionStorage.getItem(t||zn);e&&(Bn=JSON.parse(e))}catch{}},[t]),x.useLayoutEffect(()=>{let t=n?.enableScrollRestoration(Bn,()=>window.scrollY,e?(t,n)=>Vn(t,n,a,e):void 0);return()=>t&&t()},[n,a,e]),x.useLayoutEffect(()=>{if(r!==!1){if(typeof r==`number`){window.scrollTo(0,r);return}try{if(o.hash){let e=document.getElementById(decodeURIComponent(o.hash.slice(1)));if(e){e.scrollIntoView();return}}}catch{T(!1,`"${o.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`)}i!==!0&&window.scrollTo(0,0)}},[o,r,i]))}function Un(e,t){let{capture:n}=t||{};x.useEffect(()=>{let t=n==null?void 0:{capture:n};return window.addEventListener(`pagehide`,e,t),()=>{window.removeEventListener(`pagehide`,e,t)}},[e,n])}function Wn(e,{relative:t}={}){let n=x.useContext(Ke);w(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Mn(`useViewTransitionState`),i=dt(e,{relative:t});if(!n.isTransitioning)return!1;let a=Ce(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=Ce(n.nextLocation.pathname,r)||n.nextLocation.pathname;return be(i.pathname,o)!=null||be(i.pathname,a)!=null}var Gn=g(),Kn=`https://github.com/qusay4421/persona3-website/releases/download/assets-v1`,qn=`${Kn}/main1.mp4`,Jn=`${Kn}/main2.mp4`,Yn=`${Kn}/main3.mp4`,Xn=`${Kn}/main2loop.mp4`,Zn=`/persona3-website/assets/go_into_tab-CQts3s-e.wav`,Qn=`/persona3-website/assets/go_out_tab-DIsaE49g.wav`,$n=`/persona3-website/assets/item_navigation-DvvIJatJ.wav`,er=`/persona3-website/assets/volume-NErkbbqU.wav`,tr=`/persona3-website/assets/%E3%82%AD%E3%83%9F%E3%81%AE%E8%A8%98%E6%86%B6%20-%20Yumi%20Kawamura%20-%20Topic%20(192k)-lpWIkGCy.mp3`,nr=`/persona3-website/assets/Full%20Moon%20Full%20Life%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-CoJXOShb.mp3`,rr=`/persona3-website/assets/%E3%82%84%E3%81%99%E3%82%89%E3%81%8E%20-Reload-%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-B6oMRYSt.mp3`,ir=`/persona3-website/assets/When%20The%20Moon's%20Reaching%20Out%20Stars%20-Reload-%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-B3h5cJ-4.mp3`,ar=`/persona3-website/assets/Color%20Your%20Night%20-%20Lotus%20Juice%20-%20Topic%20(192k)-DfJOeTsO.mp3`,or=`/persona3-website/assets/%E6%B7%B1%E5%B1%A4%E5%BF%83%E7%90%86%20-Reload-%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-DpP_AQ1s.mp3`,sr=`/persona3-website/assets/It's%20Going%20Down%20Now%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-BgarKKk-.mp3`,cr=`/persona3-website/assets/Changing%20Seasons%20-Reload-%20-%20Azumi%20Takahashi%20-%20Topic%20(192k)-Cjb7r8yP.mp3`,lr=`p3-sfx-volume`,ur=`p3-music-volume`,dr=(()=>{let e=localStorage.getItem(lr);return e===null?1:parseFloat(e)})(),fr=(()=>{let e=localStorage.getItem(ur);return e===null?.7:parseFloat(e)})(),pr={};function mr(e){pr[e]||(pr[e]=new Audio(e));let t=pr[e];t.volume=dr,t.currentTime=0,t.play().catch(()=>{})}function hr(){return Math.round(dr*10)}function gr(){return Math.round(fr*10)}function _r(e){dr=Math.max(0,Math.min(10,e))/10,localStorage.setItem(lr,dr)}function vr(e){fr=Math.max(0,Math.min(10,e))/10,localStorage.setItem(ur,fr),j&&(j.volume=fr)}var A={goIntoTab:()=>mr(Zn),goOutTab:()=>mr(Qn),itemNavigation:()=>mr($n),volume:()=>mr(er)},yr=[{title:`キミの記憶`,artist:`Yumi Kawamura`,src:tr},{title:`Full Moon Full Life`,artist:`Azumi Takahashi`,src:nr},{title:`やすらぎ -Reload-`,artist:`Azumi Takahashi`,src:rr},{title:`When The Moon's Reaching Out Stars`,artist:`Azumi Takahashi`,src:ir},{title:`Color Your Night`,artist:`Lotus Juice`,src:ar},{title:`深層心理 -Reload-`,artist:`Azumi Takahashi`,src:or},{title:`It's Going Down Now`,artist:`Azumi Takahashi`,src:sr},{title:`Changing Seasons -Reload-`,artist:`Azumi Takahashi`,src:cr}],j=null,br=0,xr=!1,Sr=!1,Cr=null,wr=null,Tr=null,Er=null;function Dr(){wr||(wr=new AudioContext,Tr=wr.createAnalyser(),Tr.fftSize=2048,Tr.smoothingTimeConstant=.6,Tr.connect(wr.destination))}function Or(){return Dr(),Tr}function kr(){Dr(),wr.state===`suspended`&&wr.resume()}function Ar(e){Cr=e}function jr(){Cr&&Cr({idx:br,playing:xr,shuffle:Sr})}function Mr(e){if(j&&(j.pause(),j.onended=null),Er){try{Er.disconnect()}catch{}Er=null}br=(e%yr.length+yr.length)%yr.length,j=new Audio(yr[br].src),j.volume=fr,j.onended=()=>{Pr(Sr?Math.floor(Math.random()*yr.length):(br+1)%yr.length)},Dr();try{Er=wr.createMediaElementSource(j),Er.connect(Tr),wr.state===`suspended`&&wr.resume()}catch{}}function Nr(){`mediaSession`in navigator&&(navigator.mediaSession.metadata=new MediaMetadata({title:yr[br].title,artist:yr[br].artist,album:`Persona 3 Reload`}))}`mediaSession`in navigator&&(navigator.mediaSession.setActionHandler(`play`,()=>Fr()),navigator.mediaSession.setActionHandler(`pause`,()=>Fr()),navigator.mediaSession.setActionHandler(`previoustrack`,()=>Lr()),navigator.mediaSession.setActionHandler(`nexttrack`,()=>Ir()));function Pr(e){Mr(e),j.play().catch(()=>{}),xr=!0,jr(),Nr()}function Fr(){if(!j){Pr(br);return}xr?(j.pause(),xr=!1):(j.play().catch(()=>{}),xr=!0),jr()}function Ir(){Pr(Sr?Math.floor(Math.random()*yr.length):(br+1)%yr.length)}function Lr(){j&&j.currentTime>3?(j.currentTime=0,xr||(j.play().catch(()=>{}),xr=!0,jr())):Pr((br-1+yr.length)%yr.length)}function Rr(e){Pr(e)}function zr(){Sr=!Sr,jr()}function Br(){return{idx:br,playing:xr,shuffle:Sr}}function Vr(){return!j||isNaN(j.duration)?{current:0,duration:0}:{current:j.currentTime,duration:j.duration}}function Hr(e){!j||!j.duration||(j.currentTime=Math.max(0,Math.min(j.duration,e)))}var Ur=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),M=o(((e,t)=>{t.exports=Ur()}))(),Wr=!1,Gr=[{id:`about`,label:`ABOUT ME`,page:`about`,fontSize:80,offsetX:0,offsetY:0,skew:-6,skewY:10},{id:`resume`,label:`RESUME`,page:`resume`,fontSize:66,offsetX:20,offsetY:8,skew:-11,skewY:-10},{id:`github`,label:`GITHUB LINK`,page:`github`,external:`https://github.com/qusay4421`,fontSize:68,offsetX:8,offsetY:6,skew:0,skewY:-4},{id:`socials`,label:`SOCIALS`,page:`socials`,fontSize:74,offsetX:16,offsetY:8,skew:-3,skewY:5},{id:`sideproj`,label:`SIDE PROJECTS`,page:`sideproj`,fontSize:56,offsetX:10,offsetY:6,skew:-4,skewY:7},{id:`volume`,label:`VOLUME`,page:`volume`,fontSize:72,offsetX:14,offsetY:6,skew:-5,skewY:6}],Kr=[(e,t)=>`polygon(0px 0px, ${e}px ${t*.5}px, 0px ${t}px)`,(e,t)=>`polygon(0px 0px, ${e}px ${t*.5}px, 0px ${t}px)`,(e,t)=>`polygon(0px 0px, ${e}px ${t*.5}px, 0px ${t}px)`,(e,t)=>`polygon(0px 0px, ${e}px ${t*.5}px, 0px ${t}px)`,(e,t)=>`polygon(0px 0px, ${e}px ${t*.5}px, 0px ${t}px)`];function qr({onNavigate:e}){let[t,n]=(0,x.useState)(0),[r,i]=(0,x.useState)(Wr),[a,o]=(0,x.useState)(0),s=e=>{n(e),o(e=>e+1)};return(0,x.useEffect)(()=>{if(Wr)return;let e=setTimeout(()=>{i(!0),Wr=!0},1e3);return()=>clearTimeout(e)},[]),(0,x.useEffect)(()=>{let n=n=>{if(n.key===`ArrowUp`&&(A.itemNavigation(),s((t-1+Gr.length)%Gr.length)),n.key===`ArrowDown`&&(A.itemNavigation(),s((t+1)%Gr.length)),n.key===`Enter`){let n=Gr[t];n.external?window.open(n.external,`_blank`):e?.(n.page)}};return window.addEventListener(`keydown`,n),()=>window.removeEventListener(`keydown`,n)},[t]),(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`style`,{children:`
      ...
      `}),(0,M.jsxs)(`div`,{className:`p3-overlay`,children:[(0,M.jsxs)(`div`,{className:`p3-name-tag`,children:[(0,M.jsx)(`span`,{children:`Qussai's`}),(0,M.jsx)(`span`,{children:`Persona`})]}),(0,M.jsx)(`nav`,{className:`p3-menu`,children:Gr.map((n,i)=>{let o=t===i,c=Math.abs(i-t),l=o?1:Math.max(.5,1-c*.2),u=n.label.length*n.fontSize*.6+80,d=n.fontSize*.94,f=Kr[i]??Kr[0];return(0,M.jsxs)(`a`,{href:`#`,className:`p3-row ${o?`active`:``} ${r?`mounted`:``}`,style:{marginRight:n.offsetX,marginTop:n.offsetY,transitionDelay:r?`${i*80}ms`:`0ms`},onClick:t=>{t.preventDefault(),n.external?window.open(n.external,`_blank`):e?.(n.page)},onMouseEnter:()=>{A.itemNavigation(),s(i)},"aria-current":o?`page`:void 0,children:[(0,M.jsx)(`div`,{className:`p3-glow`}),(0,M.jsxs)(`div`,{className:`p3-skew-wrap`,style:{transform:`skewX(${n.skew}deg) skewY(${n.skewY}deg)`},children:[(0,M.jsx)(`div`,{className:`p3-shadow-tri${o?` pop`:``}`,style:{width:u,height:d,clipPath:f(u,d)}},o?`pop-${i}-${a}`:`idle-${i}`),(0,M.jsx)(`div`,{className:`p3-highlight`,style:{width:u,height:d,clipPath:f(u,d),transform:`translateY(-50%) scaleX(${o?1:0})`}}),(0,M.jsxs)(`div`,{className:`p3-label-wrap`,style:{opacity:l},children:[(0,M.jsx)(`span`,{className:`p3-label-base p3-label-dark`,style:{fontSize:n.fontSize},children:n.label}),(0,M.jsx)(`span`,{className:`p3-label-base p3-label-bright`,style:{fontSize:n.fontSize,clipPath:f(u,d)},children:n.label})]})]})]},n.id)})}),(0,M.jsxs)(`div`,{className:`p3-hint ${r?`mounted`:``}`,children:[(0,M.jsxs)(`div`,{className:`p3-hint-row`,children:[(0,M.jsx)(`span`,{className:`p3-hint-key`,children:`↑↓`}),(0,M.jsx)(`span`,{children:`NAVIGATE`})]}),(0,M.jsxs)(`div`,{className:`p3-hint-row`,children:[(0,M.jsx)(`span`,{className:`p3-hint-key`,children:`↵`}),(0,M.jsx)(`span`,{children:`CONFIRM`})]})]})]})]})}var Jr=[{id:`i`,badge:`I`,title:`EDUCATION`,subtitle:`University of Toronto · CS`,rank:3},{id:`ii`,badge:`II`,title:`SKILLS`,subtitle:`Languages / Tools / Methods`,rank:15},{id:`iii`,badge:`III`,title:`PROJECTS`,subtitle:`Featured Work`,rank:8},{id:`iv`,badge:`IV`,title:`EXPERIENCE`,subtitle:`Roles & Volunteer Work`,rank:3}],Yr=[{index:`01`,title:`Data Structures & Algorithms`,status:`Done`},{index:`02`,title:`Machine Learning`,status:`Done`},{index:`03`,title:`Operating Systems`,status:`Done`},{index:`04`,title:`Web Development`,status:`Done`},{index:`05`,title:`Computer Architecture`,status:`Done`},{index:`06`,title:`Linear Algebra`,status:`Done`},{index:`07`,title:`Systems Design`,status:`Active`}],Xr=[{index:`01`,title:`Python · Lua · Java · JavaScript · C · C++`,status:`Lang`},{index:`02`,title:`C# · CSS · HTML · SQL · Assembly · Haskell`,status:`Lang`},{index:`03`,title:`Racket · MATLAB`,status:`Lang`},{index:`04`,title:`Git · TensorFlow · OpenCV · Valgrind · NumPy`,status:`Tools`},{index:`05`,title:`REST API · PostgreSQL · JIRA · VS Code · Linux`,status:`Tools`},{index:`06`,title:`Agile · Scrum · SOLID · MVC · Design Patterns`,status:`Method`}],Zr=[{index:`01`,title:`Sign Language Detection System`,status:`WIP`},{index:`02`,title:`CallLog Analytics`,status:`Done`},{index:`03`,title:`Linux Shell`,status:`Done`},{index:`04`,title:`Paint Desktop Drawing Program`,status:`Done`},{index:`05`,title:`Job Scheduler w/ Sync`,status:`Done`},{index:`06`,title:`Treemap Visualiser`,status:`Done`},{index:`07`,title:`Balatro Clone`,status:`Done`},{index:`08`,title:`Sokoban Game (RISC-V)`,status:`Done`}],Qr=[{index:`01`,title:`Exceed Robotics — Programming Tutor`,status:`2024–25`},{index:`02`,title:`Lady of Learning — Private Tutor`,status:`2025–Now`},{index:`03`,title:`Technical Volunteer`,status:`2021–Now`}];function $r({src:e,onBack:t}){let[n,r]=(0,x.useState)(1),[i,a]=(0,x.useState)(!1);return(0,x.useEffect)(()=>{let e=setTimeout(()=>a(!0),80);return()=>clearTimeout(e)},[]),(0,x.useEffect)(()=>{let e=e=>{e.key===`ArrowUp`&&(A.itemNavigation(),r(e=>(e-1+Jr.length)%Jr.length)),e.key===`ArrowDown`&&(A.itemNavigation(),r(e=>(e+1)%Jr.length)),e.key===`ArrowLeft`&&t(),(e.key===`Escape`||e.key===`Backspace`)&&t()};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[t]),(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(`video`,{src:e,autoPlay:!0,loop:!0,muted:!0,playsInline:!0}),(0,M.jsx)(`div`,{className:`resume-entry-mask`,"aria-hidden":`true`,children:(0,M.jsx)(`video`,{className:`resume-entry-video`,src:e,autoPlay:!0,loop:!0,muted:!0,playsInline:!0})}),(0,M.jsx)(`style`,{children:`
      ...
      `}),(0,M.jsx)(`div`,{className:`sc-root`,role:`navigation`,children:ci.map((e,i)=>(0,M.jsxs)(`div`,{className:`sc-bar-outer${t===i?` active`:``}${r?` mounted`:``}`,onClick:()=>{A.goIntoTab(),t===i?window.open(e.href,`_blank`):n(i)},onMouseEnter:()=>{A.itemNavigation(),n(i)},children:[(0,M.jsx)(`div`,{className:`sc-bar-red`}),(0,M.jsxs)(`div`,{className:`sc-bar`,children:[(0,M.jsx)(`img`,{className:`sc-char`,src:oi[i],alt:``}),(0,M.jsx)(`div`,{className:`sc-bar-fill`}),(0,M.jsx)(`div`,{className:`sc-bar-shade`}),(0,M.jsxs)(`div`,{className:`sc-bar-content`,children:[(0,M.jsx)(`div`,{className:`sc-role`,children:si[i].text}),(0,M.jsx)(`div`,{className:`sc-main`,children:(0,M.jsxs)(`div`,{className:`sc-main-top`,children:[(0,M.jsx)(`div`,{className:`sc-icon`,children:e.icon}),(0,M.jsx)(`div`,{className:`sc-label`,children:e.label})]})}),(0,M.jsx)(`div`,{className:`sc-stats`,children:e.stats.map(e=>(0,M.jsxs)(`div`,{className:`sc-stat`,children:[(0,M.jsxs)(`div`,{className:`sc-stat-top`,children:[(0,M.jsx)(`span`,{className:`sc-stat-tag`,style:{color:e.color,borderColor:e.color},children:e.tag}),(0,M.jsx)(`span`,{className:`sc-stat-num`,children:e.value})]}),(0,M.jsxs)(`div`,{className:`sc-stat-bars`,children:[(0,M.jsx)(`div`,{className:`sc-stat-bar-color`,style:{background:e.color}}),(0,M.jsx)(`div`,{className:`sc-stat-bar-black`})]})]},e.tag))})]})]})]},e.id))}),r&&(0,M.jsxs)(`div`,{className:`sc-right-nav`,children:[(0,M.jsx)(`span`,{className:`sc-nav-arrow left`,children:`◄`}),(0,M.jsx)(`span`,{className:`sc-nav-btn`,children:`LB`}),(0,M.jsx)(`span`,{className:`sc-nav-label`,children:ci[t].label}),(0,M.jsx)(`span`,{className:`sc-nav-btn`,children:`RB`}),(0,M.jsx)(`span`,{className:`sc-nav-arrow right`,children:`►`})]},t),r&&Array.from({length:ci[t].bars}).map((e,n)=>(0,M.jsxs)(`div`,{className:`sc-info-bar-wrap${a===n?` selected`:``}`,style:{top:`${155+n*52}px`,animationDelay:`${n*50}ms`},onClick:()=>{A.goIntoTab(),o(n)},onMouseEnter:()=>{A.itemNavigation(),o(n)},children:[ci[t].newBars.includes(n)&&(0,M.jsx)(`img`,{className:`sc-info-bar-new`,src:`/persona3-website/assets/newsign-Dnb_rKJG.png`,alt:``}),(0,M.jsxs)(`div`,{className:`sc-info-bar`,children:[(0,M.jsx)(`img`,{className:`sc-info-bar-icon`,src:ci[t].barIcon,alt:``}),(0,M.jsxs)(`span`,{className:`sc-info-bar-text`,children:[ci[t].links[n].slice(0,10),`...`]}),(0,M.jsx)(`span`,{className:`sc-info-bar-box`,children:`VIEWS`}),(0,M.jsx)(`span`,{className:`sc-info-bar-count`,children:ci[t].counts[n]})]})]},`bar-${t}-${n}`)),(0,M.jsxs)(`div`,{className:`sc-footer${r?` mounted`:``}`,children:[(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`↑↓`}),(0,M.jsx)(`span`,{children:`SELECT`})]}),(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`↵`}),(0,M.jsx)(`span`,{children:`OPEN`})]}),(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`ESC`}),(0,M.jsx)(`span`,{children:`BACK`})]})]})]})}var ui=`/persona3-website/assets/mainm-D0vWT90G.png`,di=`/persona3-website/assets/mainm2-zj4gwCr7.png`,fi=`/persona3-website/assets/mainf-ycBO1dgh.png`,pi=[ei,ti,ni],mi=[ui,di,fi],hi=[{upper:[`QUSSAI ALBALKHI`,`COMPUTER SCIENCE @ UNIVERSITY OF TORONTO`,`GTA, ONTARIO · GRADUATING 2027`],lower:`qusayalbalkhi29@gmail.com`},{upper:[`TUTORED 20+ YOUTH LEARNERS IN PROGRAMMING AT EXCEED ROBOTICS`,`IMPROVED STUDENTS' MATH & CALCULUS GRADES BY 40% AT LADY OF LEARNING`,`VOLUNTEERED TECH SUPPORT TO 30+ COMMUNITY MEMBERS SINCE 2021`],lower:`TEACHING & COMMUNITY EXPERIENCE`},{upper:[`BUILT A SIGN LANGUAGE DETECTOR USING ML & COMPUTER VISION (IN PROGRESS)`,`RECREATED BALATRO CARD GAME FROM SCRATCH IN LUA / LÖVE2D`,`CODED A SOKOBAN GAME ENTIRELY IN RISC-V ASSEMBLY`],lower:`HIGHLIGHT PROJECTS`}],gi=[{text:`LEADER`,color:`#e8c100`,bg:`rgba(232,193,0,0.12)`,border:`rgba(232,193,0,0.5)`},{text:`PARTY`,color:`#4a8fff`,bg:`rgba(74,143,255,0.12)`,border:`rgba(74,143,255,0.5)`},{text:`PARTY`,color:`#4a8fff`,bg:`rgba(74,143,255,0.12)`,border:`rgba(74,143,255,0.5)`}],_i=[{id:`about`,label:`ABOUT ME`,handle:`@qussaialbalkhi`,href:``,icon:`👤`,barIcon:ri,bars:1,newBars:[],counts:[``],links:[``],stats:[{tag:`YR`,value:`3RD`,color:`#9147ff`},{tag:`GPA`,value:`CS`,color:`#bf94ff`}]},{id:`funfact`,label:`FUN FACT`,handle:`@qussaialbalkhi`,href:``,icon:`📖`,barIcon:ii,bars:1,newBars:[],counts:[``],links:[``],stats:[{tag:`STU`,value:`20+`,color:`#e1306c`},{tag:`IMP`,value:`+40%`,color:`#f77737`}]},{id:`projects`,label:`HIGHLIGHT`,handle:`@qussaialbalkhi`,href:``,icon:`⚡`,barIcon:ai,bars:1,newBars:[],counts:[``],links:[``],stats:[{tag:`PRJ`,value:`8`,color:`#00f2ea`},{tag:`LNG`,value:`15+`,color:`#ff0050`}]}];function vi({onBack:e}){let[t,n]=(0,x.useState)(0),[r,i]=(0,x.useState)(0),[a,o]=(0,x.useState)(!1),[s,c]=(0,x.useState)(!1),[l,u]=(0,x.useState)(0),[d,f]=(0,x.useState)(null),[p,m]=(0,x.useState)(0),[h,g]=(0,x.useState)(!1);(0,x.useEffect)(()=>{let e=setTimeout(()=>o(!0),60);return()=>clearTimeout(e)},[]);let _=()=>{g(!0),setTimeout(()=>{c(!1),g(!1)},520)};return(0,x.useEffect)(()=>{let a=a=>{if(!h){if(a.key===`ArrowUp`){A.itemNavigation();let e=(t-1+_i.length)%_i.length;n(e),s?(f(hi[r]),m(e=>e+1),u(e=>e+1),setTimeout(()=>{i(e),f(null)},193)):i(e)}if(a.key===`ArrowDown`){A.itemNavigation();let e=(t+1)%_i.length;n(e),s?(f(hi[r]),m(e=>e+1),u(e=>e+1),setTimeout(()=>{i(e),f(null)},193)):i(e)}a.key===`Enter`&&c(!0),a.key===`ArrowRight`&&c(!0),a.key===`ArrowLeft`&&(s?_():e()),(a.key===`Escape`||a.key===`Backspace`)&&(s?_():e())}};return window.addEventListener(`keydown`,a),()=>window.removeEventListener(`keydown`,a)},[t,s,h,r,e]),(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(`video`,{src:Yn,autoPlay:!0,loop:!0,muted:!0,playsInline:!0}),(s||h)&&(0,M.jsx)(`div`,{className:`sc-dim`},`dim-${t}`),(s||h)&&(0,M.jsxs)(`div`,{className:`sc-reveal-panel${a?` mounted`:``}${h?` exiting`:``}`,children:[d&&(0,M.jsxs)(`div`,{className:`sc-text-layer sc-text-layer-exit`,children:[(0,M.jsx)(`div`,{className:`sc-reveal-upper-bar`,children:d.upper.map(e=>(0,M.jsx)(`div`,{className:`sc-reveal-upper-line`,children:e},e))}),(0,M.jsx)(`div`,{className:`sc-reveal-lower-bar`,children:d.lower})]},p),(0,M.jsxs)(`div`,{className:`sc-text-layer${l>0?` sc-text-layer-enter`:``}`,children:[(0,M.jsx)(`div`,{className:`sc-reveal-upper-bar`,children:hi[r].upper.map(e=>(0,M.jsx)(`div`,{className:`sc-reveal-upper-line`,children:e},e))}),(0,M.jsx)(`div`,{className:`sc-reveal-lower-bar`,children:hi[r].lower})]},`content-${r}`)]},`panel`),(s||h)&&(0,M.jsxs)(`div`,{className:`sc-right-nav`,children:[(0,M.jsx)(`span`,{className:`sc-nav-arrow left`,children:`⮝`}),(0,M.jsx)(`span`,{className:`sc-nav-btn`,children:`U`}),Array.from({length:_i.length}).map((e,t)=>(0,M.jsx)(`span`,{className:`sc-nav-dot`},t)),(0,M.jsx)(`span`,{className:`sc-nav-btn`,children:`D`}),(0,M.jsx)(`span`,{className:`sc-nav-arrow right`,children:`⮟`})]},`nav-${t}`),(s||h)&&(0,M.jsxs)(`div`,{className:`sc-main-portrait-shell${a?` mounted`:``}${h?` exiting`:``}`,children:[(0,M.jsx)(`img`,{className:`sc-main-portrait`,src:mi[r],alt:``}),l>0&&(0,M.jsx)(`div`,{className:`sc-portrait-flash`},l)]},`portrait`),(0,M.jsx)(`style`,{children:`
      ...
      `}),(0,M.jsx)(`div`,{className:`sc-root`,role:`navigation`,children:_i.map((e,o)=>(0,M.jsxs)(`div`,{className:`sc-bar-outer${t===o?` active`:``}${a?` mounted`:``}`,onClick:()=>{A.goIntoTab(),s&&t!==o?(f(hi[r]),m(e=>e+1),u(e=>e+1),setTimeout(()=>{i(o),f(null)},193)):i(o),n(o),c(!0)},onMouseEnter:()=>{s||(A.itemNavigation(),n(o))},children:[(0,M.jsx)(`div`,{className:`sc-bar-red`}),(0,M.jsxs)(`div`,{className:`sc-bar`,children:[(0,M.jsx)(`img`,{className:`sc-char`,src:pi[o],alt:``}),(0,M.jsx)(`div`,{className:`sc-bar-fill`}),(0,M.jsx)(`div`,{className:`sc-bar-shade`}),(0,M.jsxs)(`div`,{className:`sc-bar-content`,children:[(0,M.jsx)(`div`,{className:`sc-role`,children:gi[o].text}),(0,M.jsx)(`div`,{className:`sc-main`,children:(0,M.jsx)(`div`,{className:`sc-main-top`,children:(0,M.jsx)(`div`,{className:`sc-label`,children:e.label})})})]})]})]},e.id))}),(0,M.jsxs)(`div`,{className:`sc-footer${a?` mounted`:``}`,children:[(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`↑↓`}),(0,M.jsx)(`span`,{children:`SELECT`})]}),(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`↵`}),(0,M.jsx)(`span`,{children:`REVEAL`})]}),(0,M.jsxs)(`div`,{className:`sc-footer-row`,children:[(0,M.jsx)(`span`,{className:`sc-footer-key`,children:`ESC`}),(0,M.jsx)(`span`,{children:`BACK`})]})]})]})}var yi=yr.length+1;function bi(e){return!e||isNaN(e)?`0:00`:`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function xi({label:e,level:t,isFocused:n,onFocus:r,onSetLevel:i}){return(0,M.jsxs)(`div`,{className:`vol-slider${n?` focused`:``}`,onClick:r,onMouseEnter:r,children:[(0,M.jsxs)(`div`,{className:`vol-slider-header`,children:[(0,M.jsx)(`span`,{className:`vol-slider-cursor`,children:n?`►`:` `}),(0,M.jsx)(`span`,{className:`vol-slider-label`,children:e})]}),(0,M.jsxs)(`div`,{className:`vol-track`,children:[(0,M.jsx)(`div`,{className:`vol-bars`,children:Array.from({length:10},(e,r)=>{let a=r<t;return(0,M.jsx)(`div`,{className:`vol-bar`,style:{height:`${30+(r+1)*7}%`,background:a?n?`#ff2a2a`:`rgba(255,100,100,0.5)`:`rgba(255,255,255,0.1)`,boxShadow:a&&n?`0 0 8px rgba(255,42,42,0.5)`:`none`},onClick:e=>{e.stopPropagation(),i(r+1)}},r)})}),(0,M.jsx)(`div`,{className:`vol-number`,style:{opacity:n?1:.4},children:t})]})]})}function Si({onBack:e}){let[t,n]=(0,x.useState)(!1),[r,i]=(0,x.useState)(0),[a,o]=(0,x.useState)(0),[s,c]=(0,x.useState)(hr),[l,u]=(0,x.useState)(gr),[d,f]=(0,x.useState)({current:0,duration:0}),p=Br(),[m,h]=(0,x.useState)(p.idx),[g,_]=(0,x.useState)(p.playing),[v,y]=(0,x.useState)(p.shuffle),b=(0,x.useRef)(null);(0,x.useEffect)(()=>{let e=setTimeout(()=>n(!0),80);return()=>clearTimeout(e)},[]),(0,x.useEffect)(()=>(Ar(({idx:e,playing:t,shuffle:n})=>{h(e),_(t),y(n)}),()=>Ar(null)),[]),(0,x.useEffect)(()=>{let e=setInterval(()=>f(Vr()),500);return()=>clearInterval(e)},[]),(0,x.useEffect)(()=>{let t=t=>{if(t.key===`Escape`||t.key===`Backspace`){e();return}r===0||r===1?(t.key===`ArrowRight`&&ee(1),t.key===`ArrowLeft`&&ee(-1),t.key===`ArrowUp`&&(A.itemNavigation(),r===0?(i(2),o(yi-1)):i(0)),t.key===`ArrowDown`&&(A.itemNavigation(),r===1?(i(2),o(0)):i(1))):(t.key===`ArrowUp`&&(A.itemNavigation(),a===0?i(1):o(e=>e-1)),t.key===`ArrowDown`&&(A.itemNavigation(),a>=yi-1?i(0):o(e=>e+1)),t.key===`Enter`&&(A.goIntoTab(),a<yr.length?Rr(a):zr()))};return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[r,a,s,l,e]);function ee(e){if(r===0){let t=Math.max(1,Math.min(10,s+e));if(t===s)return;c(t),_r(t),A.volume()}else{let t=Math.max(1,Math.min(10,l+e));if(t===l)return;u(t),vr(t)}}function S(e){c(e),_r(e),A.volume()}function C(e){u(e),vr(e)}function w(e){let t=b.current.getBoundingClientRect();Hr(Math.max(0,Math.min(1,(e.clientX-t.left)/t.width))*d.duration)}let T=d.duration>0?d.current/d.duration*100:0;return(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(`video`,{src:Yn,autoPlay:!0,loop:!0,muted:!0,playsInline:!0}),(0,M.jsx)(`style`,{children:`
        @import url('https://fonts.googleapis.com/css2?family=Anton&family=Bebas+Neue&display=swap');
      ...
      `}),(0,M.jsxs)(`div`,{className:`vp-overlay`,children:[(0,M.jsxs)(`div`,{className:`vol-panel${t?` mounted`:``}`,children:[(0,M.jsx)(`div`,{className:`vol-panel-title`,children:`VOLUME`}),(0,M.jsx)(xi,{label:`SFX`,level:s,isFocused:r===0,onFocus:()=>{A.itemNavigation(),i(0)},onSetLevel:S}),(0,M.jsx)(`div`,{className:`vol-divider`}),(0,M.jsx)(xi,{label:`MUSIC`,level:l,isFocused:r===1,onFocus:()=>{A.itemNavigation(),i(1)},onSetLevel:C}),(0,M.jsxs)(`div`,{className:`vol-hint`,children:[(0,M.jsxs)(`div`,{className:`vol-hint-row`,children:[(0,M.jsx)(`span`,{className:`vol-hint-key`,children:`◄ ►`}),(0,M.jsx)(`span`,{children:`ADJUST`})]}),(0,M.jsxs)(`div`,{className:`vol-hint-row`,children:[(0,M.jsx)(`span`,{className:`vol-hint-key`,children:`↑ ↓`}),(0,M.jsx)(`span`,{children:`SWITCH`})]}),(0,M.jsxs)(`div`,{className:`vol-hint-row`,children:[(0,M.jsx)(`span`,{className:`vol-hint-key`,children:`ESC`}),(0,M.jsx)(`span`,{children:`BACK`})]})]})]}),(0,M.jsxs)(`div`,{className:`music-panel${t?` mounted`:``}`,children:[(0,M.jsx)(`div`,{className:`music-panel-title`,children:`RADIO`}),(0,M.jsxs)(`div`,{className:`music-track-list`,children:[yr.map((e,t)=>{let n=m===t;return(0,M.jsxs)(`div`,{className:[`music-track-row`,n?`active`:``,r===2&&a===t?`kbd`:``].join(` `).trim(),onClick:()=>{A.goIntoTab(),Rr(t)},children:[(0,M.jsx)(`span`,{className:`music-track-num`,children:n&&g?`►`:String(t+1).padStart(2,`0`)}),(0,M.jsx)(`span`,{className:`music-track-title`,children:e.title}),(0,M.jsx)(`span`,{className:`music-track-artist`,children:e.artist})]},t)}),(0,M.jsxs)(`div`,{className:[`music-track-row music-shuffle-row`,v?`active`:``,r===2&&a===yr.length?`kbd`:``].join(` `).trim(),onClick:()=>{A.goIntoTab(),zr()},children:[(0,M.jsx)(`span`,{className:`music-track-num`,children:`⇌`}),(0,M.jsx)(`span`,{className:`music-track-title`,children:`SHUFFLE`}),(0,M.jsx)(`span`,{className:`music-track-artist`,children:v?`ON`:`OFF`})]})]}),(0,M.jsxs)(`div`,{className:`music-progress-wrap`,children:[(0,M.jsx)(`div`,{className:`music-progress-bar`,ref:b,onClick:w,children:(0,M.jsx)(`div`,{className:`music-progress-fill`,style:{width:`${T}%`}})}),(0,M.jsxs)(`div`,{className:`music-progress-times`,children:[(0,M.jsx)(`span`,{children:bi(d.current)}),(0,M.jsx)(`span`,{children:bi(d.duration)})]})]}),(0,M.jsxs)(`div`,{className:`music-controls`,children:[(0,M.jsx)(`button`,{className:`music-btn`,onClick:()=>{A.itemNavigation(),Lr()},children:`◄◄`}),(0,M.jsx)(`button`,{className:`music-btn music-play-btn`,onClick:()=>{A.goIntoTab(),Fr()},children:g?`⏸`:`▶`}),(0,M.jsx)(`button`,{className:`music-btn`,onClick:()=>{A.itemNavigation(),Ir()},children:`▶▶`})]})]})]})]})}var Ci=[{id:`asl`,label:`ASL TRANSLATOR`,desc:`Real-time sign language recognition in the browser. MediaPipe + LSTM, TensorFlow.js.`,href:`https://github.com/qusay4421/ASLTranslator`},{id:`pathfinder`,label:`PATHFINDER`,desc:`UofT course planning dashboard. React, Vite, Supabase.`,href:`https://github.com/qusay4421/PathFinder`},{id:`dynamo`,label:`DYNAMO-LITE`,desc:`Distributed, sharded, replicated key-value store in Go with tunable quorums.`,href:`https://github.com/qusay4421/dynamo-lite`},{id:`igloo`,label:`IGLOO SITE`,desc:`Interactive WebGL studio site. Custom GLSL ice shaders, React Three Fiber, GSAP.`,href:`https://github.com/qusay4421/igloo-site`},{id:`crdt`,label:`CRDT-RS`,desc:`State-based CRDTs in Rust with property tests for the convergence laws.`,href:`https://github.com/qusay4421/crdt-rs`}];function wi({onBack:e}){let[t,n]=(0,x.useState)(0),[r,i]=(0,x.useState)(!1);return(0,x.useEffect)(()=>{let e=setTimeout(()=>i(!0),60);return()=>clearTimeout(e)},[]),(0,x.useEffect)(()=>{let r=r=>{r.key===`ArrowUp`&&(A.itemNavigation(),n(e=>(e-1+Ci.length)%Ci.length)),r.key===`ArrowDown`&&(A.itemNavigation(),n(e=>(e+1)%Ci.length)),r.key===`Enter`&&window.open(Ci[t].href,`_blank`),(r.key===`Escape`||r.key===`Backspace`||r.key===`ArrowLeft`)&&e()};return window.addEventListener(`keydown`,r),()=>window.removeEventListener(`keydown`,r)},[t,e]),(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(`video`,{src:Yn,autoPlay:!0,loop:!0,muted:!0,playsInline:!0}),(0,M.jsx)(`style`,{children:`
        .sp-root {
          position: absolute;
          inset: 0;
          z-index: 10;
      ...
      `}),(0,M.jsxs)(`div`,{className:`sp-root`,children:[(0,M.jsx)(`div`,{className:`sp-title ${r?`mounted`:``}`,children:`SIDE PROJECTS`}),Ci.map((e,i)=>(0,M.jsxs)(`a`,{href:e.href,target:`_blank`,rel:`noreferrer`,className:`sp-row ${t===i?`active`:``} ${r?`mounted`:``}`,style:{transitionDelay:r?`${i*70}ms`:`0ms`},onMouseEnter:()=>{A.itemNavigation(),n(i)},children:[(0,M.jsx)(`span`,{className:`sp-label`,children:e.label}),(0,M.jsx)(`div`,{className:`sp-desc`,children:e.desc})]},e.id))]}),(0,M.jsx)(`div`,{className:`sp-hint`,children:`ENTER: OPEN \xA0·\xA0 ESC: BACK`})]})}function Ti({src:e,className:t=``,style:n,videoRef:r}){let i=(0,x.useRef)(null),a=r??i;(0,x.useEffect)(()=>{let e=a.current;e&&e.play().catch(()=>{e.muted=!0,e.play()})},[e]);let o={position:`absolute`,inset:0,width:`100%`,height:`100%`,objectFit:`cover`};return(0,M.jsx)(`div`,{className:`seamless-video ${t}`,style:{position:`absolute`,inset:0,...n},children:(0,M.jsx)(`video`,{ref:a,src:e,autoPlay:!0,loop:!0,playsInline:!0,style:o})})}function Ei({firstSrc:e,loopSrc:t,className:n=``,style:r}){let[i,a]=(0,x.useState)(!1),o=(0,x.useRef)(null),s=(0,x.useRef)(null);(0,x.useEffect)(()=>{let e=o.current,t=s.current;if(!e||!t)return;let n=()=>a(!0),r=()=>{!e.duration||isNaN(e.duration)||e.duration-e.currentTime<=.1&&t.paused&&t.play().catch(()=>{})};return e.addEventListener(`ended`,n),e.addEventListener(`timeupdate`,r),()=>{e.removeEventListener(`ended`,n),e.removeEventListener(`timeupdate`,r)}},[e]);let c={position:`absolute`,inset:0,width:`100%`,height:`100%`,objectFit:`cover`};return(0,M.jsxs)(`div`,{className:`crossfade-videos ${n}`,style:{position:`absolute`,inset:0,...r},children:[(0,M.jsx)(`video`,{ref:s,src:t,loop:!0,muted:!0,playsInline:!0,preload:`auto`,style:{...c,zIndex:1}}),(0,M.jsx)(`video`,{ref:o,src:e,autoPlay:!0,muted:!0,playsInline:!0,style:{...c,zIndex:2,opacity:i?0:1}})]})}var Di=[{count:3,amp:.18,phase:.6},{count:6,amp:.08,phase:1.2},{count:11,amp:.04,phase:2}];function Oi(e,t,n){let r=1;for(let n of Di)r+=Math.sin(e*n.count+t*n.phase)*n.amp;return n*r}function ki(e,t,n,r,i=0){if(n<=0)return``;let a=``;for(let o=0;o<=96;o++){let s=o/96*Math.PI*2+i,c=Oi(s,r,n),l=e+Math.cos(s)*c,u=t+Math.sin(s)*c;a+=(o===0?`M`:`L`)+l.toFixed(1)+`,`+u.toFixed(1)+` `}return a+`Z`}var Ai=e=>1-(1-e)**2,ji=e=>1-(1-e)**2.6,Mi=e=>e**1.4,Ni=`donut-source-clip`,Pi=110,Fi=.12,Ii=.58;function Li({x:e,y:t,sourceClone:n,totalDuration:r=867,blobColor:i=`rgb(0, 60, 255)`,onComplete:a,onDone:o}){let s=(0,x.useRef)(null),c=(0,x.useRef)(null),l=(0,x.useRef)(null),u=(0,x.useRef)(0),d=(0,x.useRef)(null),f=(0,x.useRef)(!1);return(0,x.useLayoutEffect)(()=>{let e=s.current;if(!(!e||!n)&&(e.appendChild(n),c.current)){let e=window.innerWidth,t=window.innerHeight;c.current.setAttribute(`d`,`M0,0 H${e} V${t} H0 Z`)}},[n]),(0,x.useEffect)(()=>{o?.()},[]),(0,x.useEffect)(()=>{let n=window.innerWidth,i=window.innerHeight,o=Math.max(Math.hypot(e,t),Math.hypot(n-e,t),Math.hypot(e,i-t),Math.hypot(n-e,i-t))*1.18;f.current=!1,d.current=null;let s=n=>{d.current===null&&(d.current=n);let i=n-d.current,p=i/1e3,m=Math.min(1,i/r),h;h=m<Fi?Ai(m/Fi)*Pi:m<Ii?Pi+ji((m-Fi)/(Ii-Fi))*(o-Pi):o;let g=0;m>=Fi&&(g=Mi((m-Fi)/(1-Fi))*o);let _=window.innerWidth,v=window.innerHeight;if(c.current){let n=`M0,0 H${_} V${v} H0 Z`,r=g>0?ki(e,t,g,p,1.3):``;c.current.setAttribute(`d`,n+(r?` `+r:``))}if(l.current){let n=h>0?ki(e,t,h,p,0):``,r=g>0?ki(e,t,g,p,1.3):``;l.current.setAttribute(`d`,n+(r?` `+r:``))}m<1?u.current=requestAnimationFrame(s):f.current||(f.current=!0,a?.())};return u.current=requestAnimationFrame(s),()=>cancelAnimationFrame(u.current)},[e,t,r,a]),(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`svg`,{style:{position:`fixed`,width:0,height:0,overflow:`hidden`},"aria-hidden":`true`,children:(0,M.jsx)(`defs`,{children:(0,M.jsx)(`clipPath`,{id:Ni,clipPathUnits:`userSpaceOnUse`,children:(0,M.jsx)(`path`,{ref:c,clipRule:`evenodd`})})})}),(0,M.jsx)(`div`,{ref:s,style:{position:`fixed`,inset:0,zIndex:9991,clipPath:`url(#${Ni})`,pointerEvents:`none`}}),(0,M.jsx)(`svg`,{style:{position:`fixed`,inset:0,zIndex:9992,width:`100vw`,height:`100vh`,mixBlendMode:`color`,pointerEvents:`none`,overflow:`visible`},"aria-hidden":`true`,children:(0,M.jsx)(`path`,{ref:l,d:``,fill:i,fillRule:`evenodd`})})]})}var Ri=80,zi=3,N=50,P=1e4,Bi=.77,Vi=1.5,Hi=Array.from({length:Ri},()=>.5+Math.random()*.5);function Ui(){let e=(0,x.useRef)(null);return(0,x.useEffect)(()=>{let t=e.current;if(!t)return;let n=()=>{t.width=window.innerWidth,t.height=Math.round(window.innerHeight*.225)};n(),window.addEventListener(`resize`,n);let r=Or(),i=r.frequencyBinCount,a=new Uint8Array(i),o=new Float32Array(Ri);kr();let s=()=>kr();document.addEventListener(`click`,s),document.addEventListener(`keydown`,s);let c=Array.from({length:Ri},(e,t)=>{let n=N*(P/N)**(t/(Ri-1));return Math.min(Math.round(n/24e3*i),i-1)}),l=(1-Bi)*.4,u,d=()=>{u=requestAnimationFrame(d),r.getByteFrequencyData(a);let e=Math.sqrt(gr()/10),n=t.getContext(`2d`),i=t.width,s=t.height;n.clearRect(0,0,i,s);let f=(i-zi*(Ri-1))/Ri;for(let t=0;t<Ri;t++){let r=Math.min(1,a[c[t]]/255*Hi[t]*Vi*e);o[t]+=r>o[t]?(r-o[t])*.5:(r-o[t])*l;let i=Math.max(.01,o[t]),u=Math.max(3,i*s),d=t*(f+zi);n.globalAlpha=.4+i*.6,n.fillStyle=`#ffffff`,n.fillRect(d,s-u,f,u)}n.globalAlpha=1};return d(),()=>{cancelAnimationFrame(u),window.removeEventListener(`resize`,n),document.removeEventListener(`click`,s),document.removeEventListener(`keydown`,s)}},[]),(0,M.jsx)(`canvas`,{ref:e,style:{position:`absolute`,bottom:0,left:0,width:`100%`,height:`22.5vh`,pointerEvents:`none`,zIndex:15}})}var Wi=[`SUN`,`MON`,`TUE`,`WED`,`THU`,`FRI`,`SAT`];function Gi(){let[e,t]=(0,x.useState)(()=>new Date);(0,x.useEffect)(()=>{let e=setInterval(()=>t(new Date),1e3);return()=>clearInterval(e)},[]);let n=e=>String(e).padStart(2,`0`);return(0,M.jsxs)(`div`,{style:{position:`absolute`,top:16,right:16,zIndex:20,fontFamily:`'Anton', sans-serif`,color:`#fff`,textAlign:`right`,pointerEvents:`none`,background:`rgba(0,0,0,0.45)`,borderRadius:4,padding:`6px 12px`,lineHeight:1.25,border:`1px solid rgba(255,255,255,0.15)`},children:[(0,M.jsxs)(`div`,{style:{fontSize:18,letterSpacing:3,fontStyle:`italic`},children:[e.getMonth()+1,`/`,e.getDate(),`\xA0`,(0,M.jsx)(`span`,{style:{fontSize:13,letterSpacing:2},children:Wi[e.getDay()]})]}),(0,M.jsxs)(`div`,{style:{fontSize:13,letterSpacing:3,opacity:.85},children:[n(e.getHours()),`:`,n(e.getMinutes()),`:`,n(e.getSeconds())]})]})}function Ki({onEnter:e}){return(0,x.useEffect)(()=>{let t=t=>{t.key===`Enter`&&e()};return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e]),(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(Ti,{src:qn}),(0,M.jsx)(Ui,{}),(0,M.jsx)(Gi,{}),(0,M.jsx)(`style`,{children:`
      ...
      `}),(0,M.jsxs)(`button`,{className:`intro-enter-btn`,onClick:e,children:[(0,M.jsx)(`div`,{className:`intro-enter-label`,children:`PRESS ENTER`}),(0,M.jsx)(`div`,{className:`intro-enter-bar`})]})]})}function qi({onNavigate:e,onBack:t}){return(0,x.useEffect)(()=>{let e=e=>{(e.key===`Escape`||e.key===`Backspace`)&&t()};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[t]),(0,M.jsxs)(`div`,{id:`menu-screen`,children:[(0,M.jsx)(Ei,{firstSrc:Jn,loopSrc:Xn}),(0,M.jsx)(qr,{onNavigate:e})]})}function Ji(){let[e,t]=(0,x.useState)(`intro`),n=lt(),r=(0,x.useRef)({x:window.innerWidth/2,y:window.innerHeight/2}),i=(0,x.useRef)(!1),[a,o]=(0,x.useState)(null);(0,x.useEffect)(()=>{let e=e=>{r.current={x:e.clientX,y:e.clientY}},t=e=>{(e.key===`Enter`||e.key===`Escape`||e.key===`Backspace`)&&(r.current={x:window.innerWidth/2,y:window.innerHeight/2}),e.code===`Space`&&(e.preventDefault(),Fr()),e.ctrlKey&&e.key===`ArrowRight`&&(e.preventDefault(),Ir()),e.ctrlKey&&e.key===`ArrowLeft`&&(e.preventDefault(),Lr())};return window.addEventListener(`mousedown`,e),window.addEventListener(`keydown`,t,!0),()=>{window.removeEventListener(`mousedown`,e),window.removeEventListener(`keydown`,t,!0)}},[]);let s=(0,x.useCallback)(e=>{if(i.current)return;i.current=!0;let{x:t,y:n}=r.current,a=document.getElementById(`menu-screen`),s=a?a.cloneNode(!0):null;if(s){s.querySelectorAll(`audio`).forEach(e=>e.remove());let e=a?[...a.querySelectorAll(`video`)]:[];s.querySelectorAll(`video`).forEach((t,n)=>{let r=e[n];try{let e=document.createElement(`canvas`);e.width=r.videoWidth,e.height=r.videoHeight,e.getContext(`2d`).drawImage(r,0,0);let n=document.createElement(`img`);n.src=e.toDataURL(`image/jpeg`,.85),n.style.cssText=`position:absolute;inset:0;width:100%;height:100%;object-fit:cover;`,t.replaceWith(n)}catch{t.muted=!0}})}o({x:t,y:n,sourceClone:s,onDone:e})},[]),c=(0,x.useCallback)(()=>{o(null),i.current=!1},[]),l=(0,x.useCallback)(e=>{A.goIntoTab(),s(()=>n(`/${e}`))},[s,n]),u=(0,x.useCallback)(()=>{A.goOutTab(),s(()=>n(-1))},[s,n]),d=(0,x.useCallback)(()=>{A.goIntoTab(),s(()=>t(`menu`))},[s]),f=(0,x.useCallback)(()=>{A.goOutTab(),s(()=>t(`intro`))},[s]);return(0,M.jsxs)(M.Fragment,{children:[e===`intro`?(0,M.jsx)(Ki,{onEnter:d}):(0,M.jsxs)(It,{children:[(0,M.jsx)(Pt,{path:`/`,element:(0,M.jsx)(qi,{onNavigate:l,onBack:f})}),(0,M.jsx)(Pt,{path:`/about`,element:(0,M.jsx)(vi,{onBack:u})}),(0,M.jsx)(Pt,{path:`/resume`,element:(0,M.jsx)($r,{src:Jn,onBack:u})}),(0,M.jsx)(Pt,{path:`/socials`,element:(0,M.jsx)(li,{onBack:u})}),(0,M.jsx)(Pt,{path:`/volume`,element:(0,M.jsx)(Si,{onBack:u})}),(0,M.jsx)(Pt,{path:`/volume`,element:(0,M.jsx)(Si,{onBack:u})}),(0,M.jsx)(Pt,{path:`/sideproj`,element:(0,M.jsx)(wi,{onBack:u})})]}),a&&(0,M.jsx)(Li,{x:a.x,y:a.y,sourceClone:a.sourceClone,onDone:a.onDone,onComplete:c})]})}(0,Gn.createRoot)(document.getElementById(`root`)).render((0,M.jsx)(x.StrictMode,{children:(0,M.jsx)(wn,{basename:`/persona3-website/`,children:(0,M.jsx)(Ji,{})})}));